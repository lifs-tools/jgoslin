 ...
 */
public class LipidCompleteStructureTest {
    ...
    public void testConstructor() {
        ...
        LipidCompleteStructure lfs = new LipidCompleteStructure(head_group, knownFunctionalGroups);
        assertEquals(LipidLevel.COMPLETE_STRUCTURE, lfs.getLipidLevel());
    }
    ...
    public void testGetLipidStringThrowsException() {
        ...
        Assertions.assertEquals("LipidCompleteStructure does not know how to create a lipid string for level " + LipidLevel.UNDEFINED_LEVEL.toString(), exception.getMessage());
    }
