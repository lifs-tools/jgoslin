 ...
 */
public class LipidStructureDefinedTest {
    ...
    public void testConstructor() {
        ...
        LipidStructureDefined lfs = new LipidStructureDefined(head_group, knownFunctionalGroups);
        assertEquals(LipidLevel.STRUCTURE_DEFINED, lfs.getLipidLevel());
    }
    ...
    public void testGetLipidStringThrowsException() {
        ...
        Assertions.assertEquals("LipidStructureDefined does not know how to create a lipid string for level " + LipidLevel.UNDEFINED_LEVEL.toString(), exception.getMessage());
    }
