...
public class LipidSpeciesTest {
    ...
    public void testConstructor() {
        ...
        LipidSpecies lfs = new LipidSpecies(head_group, knownFunctionalGroups);
        assertEquals(LipidLevel.SPECIES, lfs.getLipidLevel());
    }
    ...
    public void testGetLipidString() {
        ...
        KnownFunctionalGroups knownFunctionalGroups = new KnownFunctionalGroups(StringFunctions.getResourceAsStringList("functional-groups.csv"), sfp);
        LipidSpecies lfs = new LipidSpecies(head_group, knownFunctionalGroups);
        assertEquals("FA", lfs.getLipidString());
    }
    ...
    public void testGetLipidStringThrowsException() {
        ...
        Assertions.assertEquals("LipidSpecies does not know how to create a lipid string for level " + LipidLevel.UNDEFINED_LEVEL.toString(), exception.getMessage());
    }
