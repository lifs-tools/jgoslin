...
public class HmdbParserEventHandler extends LipidBaseParserEventHandler {
    ...
    public HmdbParserEventHandler(KnownFunctionalGroups knownFunctionalGroups) {
        ...
        try {
            ...
            registered_events.put("st_sub2_hg_pre_event", this::set_head_group_name);
            registered_events.put("ganglioside_names_pre_event", this::set_head_group_name);
            ...
            registered_events.put("fa_lcb_suffix_type_pre_event", this::add_one_hydroxyl);
            registered_events.put("interlink_fa_pre_event", this::interlink_fa);
            registered_events.put("lipid_suffix_pre_event", this::lipid_suffix);
            registered_events.put("methyl_pre_event", this::add_methyl);
            registered_events.put("furan_fa_pre_event", this::furan_fa);
            registered_events.put("furan_fa_post_event", this::furan_fa_post);
            registered_events.put("furan_fa_mono_pre_event", this::furan_fa_mono);
            registered_events.put("furan_fa_di_pre_event", this::furan_fa_di);
            registered_events.put("furan_first_number_pre_event", this::furan_fa_first_number);
            registered_events.put("furan_second_number_pre_event", this::furan_fa_second_number);
        }
        catch(Exception e){
