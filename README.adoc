...
image:https://img.shields.io/github/release/lifs-tools/jg.svg["Latest Release", link="https://github.com/lifs-tools/jg/releases/latest"] 
image:https://zenodo.org/badge/DOI/10.5281/zenodo.3826474.svg["DOI", link="https://doi.org/10.5281/zenodo.3826474"]
image:https://github.com/lifs-tools/jg/actions/workflows/maven.yml/badge.svg["Build Status", link="https://github.com/lifs-tools/jg/actions/workflows/maven.yml"]
